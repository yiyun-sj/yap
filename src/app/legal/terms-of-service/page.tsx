  ...
  return (
    <main className='flex flex-1 flex-col items-center justify-center gap-8'>
      ...
      <text className='text-xs font-body font-light max-w-2xl'>
        ...
        interact with other users and content created by other users.
        <br />
        <br />
        ...
        <br />- Trick, defraud, or mislead us and other users, especially in any
        ...
        therein.
        <br />- Disparage, tarnish, or otherwise harm, in our opinion, us and/or
        the Services.
        ...
        Services.
        <br />- Engage in any automated use of the system, such as using scripts
        ...
        <br />- Use a buying agent or purchasing agent to make purchases on the
        Services.
        ...
        <br />- Your Contributions are not unsolicited or unauthorized
        advertising, promotional materials, pyramid schemes, chain letters,
        spam, mass mailings, or other forms of solicitation.
        <br />- Your Contributions are not obscene, lewd, lascivious, filthy,
        ...
        <br />- Your Contributions are not used to harass or threaten (in the
        ...
        regulation, or rule.
        <br />- Your Contributions do not violate the privacy or publicity
        rights of any third party.
        <br />- Your Contributions do not violate any applicable law concerning
        child pornography, or otherwise intended to protect the health or
        well-being of minors.
        <br />- Your Contributions do not include any offensive comments that
        are connected to race, national origin, gender, sexual preference, or
        physical handicap.
        <br />- Your Contributions do not otherwise violate, or link to material
